...
<div class="container">
    ...
    echo "<h1>Welcome " . $user["firstName"] . " ".$user["name"]."</h1>";
    ?>


    <input type="button" value="Sign Off" onclick="SignOff();">
    ...
    <form action="action_page.php" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="checkbox" name="embolie_pulmonaire" id="embolie_pulmonaire" /> <label for="embolie_pulmonaire">Embolie pulmonaire</label> ? Année : <input type="number" name="embolie_pulmonaire_annee" id="embolie_pulmonaire_annee" class="chiffres" min="1800" max="2100" placeholder="AAAA"><br /></br>
                <input type="checkbox" name="angine_de_poitrine" id="angine_de_poitrine" /> <label for="angine_de_poitrine">Angine de poitrine</label> ? Année : <input type="number" name="angine_de_poitrine_annee" id="angine_de_poitrine_annee" class="chiffres" min="1800" max="2100" placeholder="AAAA"><br /></br>
                <input type="checkbox" name="insuffisance_cardiaque" id="insuffisance_cardiaque" /> <label for="insuffisance_cardiaque">Insuffisance cardiaque</label> ? Année : <input type="number" name="insuffisance_cardiaque_annee" id="insuffisance_cardiaque_annee" class="chiffres" min="1800" max="2100" placeholder="AAAA"><br /></br>
                <input type="checkbox" name="accident_vasculaire_cerebral" id="accident_vasculaire_cerebral" /> <label for="accident_vasculaire_cerebral">Accident vasculaire cérébral</label> ? Année : <input type="number" name="accident_vasculaire_cerebral_annee" id="accident_vasculaire_cerebral_annee" class="chiffres" min="1800" max="2100" placeholder="AAAA"><br /></br>
                ...
                <input type="checkbox" name="arterite_des_membres_inferieurs" id="arterite_des_membres_inferieurs" /> <label for="arterite_des_membres_inferieurs">Artérite des membres inférieurs</label> ? Année : <input type="number" name="arterite_des_membres_inferieurs_annee" id="arterite_des_membres_inferieurs_annee" class="chiffres" min="1800" max="2100" placeholder="AAAA"><br /></br>
